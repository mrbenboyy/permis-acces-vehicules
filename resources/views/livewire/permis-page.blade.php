        ...
        <div class="max-w-sm flex mb-5">
            ...
            <div class="relative flex-grow mr-2">
                ...
                <input
                    ...
                    type="text" placeholder="Chercher immatricule, N°, Propriètaire..." value="" data-hs-combo-box-input="">
            </div>
            <!-- End SearchBox -->

            <button type="button"
                class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-teal-600 disabled:opacity-50 disabled:pointer-events-none">
                Nouveau
            </button>
        </div>
                                ...
                                <tr wire:key='{{ $perm->id }}' class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                    ...
                                    <td class=" py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="hs-dropdown relative inline-flex">
                                            ...
                                            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-10 bg-white shadow-md rounded-lg p-2 mt-5 dark:bg-neutral-800 dark:border dark:border-neutral-700"
                                                aria-labelledby="hs-dropdown-custom-icon-trigger">

                                                <button type="button" wire:click='edit({{ $perm->id }})'
                                                    class="flex mx-5 my-2 items-start font-semibold rounded-lg border border-transparent text-gray-700 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400"><svg
                                                ...
                                                <button type="button" wire:click='delete({{ $perm->id }})'
                                                    ...
                                                    class="flex text-gray-700 hover:text-blue-800  mx-5 items-center font-semibold rounded-lg border border-transparent disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400"><svg
