<div>
    <div class="flex flex-col mt-6 mx-3 lg:items-center lg:justify-center lg:ms-60 mb-5">
        <div class="max-w-sm flex mb-5">
            ...
            <a wire:navigate href="/liste_permis/ajouter_permis"><button type="button"
        ...
        <div class="-m-1.5 animate__animated animate__backInDown overflow-x-auto">
                                ...
                                <tr wire:key='{{ $perm->id }}'>
                                    ...
                                    <td class=" py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <div class="inline-flex">
                                            <a wire:navigate href="/liste_permis/permis/{{ $perm->id }}"><button
                                                    type="button"
                                                    class="flex mx-2  my-2 items-start font-semibold rounded-lg border border-transparent text-gray-700 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 hover:scale-125 duration-300"><svg
                                                        class="size-5" fill="orange" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 576 512">
                                                        <path
                                            ...
                                            <a wire:navigate href="/liste_permis/edit/{{ $perm->id }}"><button
                                                    type="button"
                                                    class="flex mx-2 my-2 items-start font-semibold rounded-lg border border-transparent text-gray-700 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 hover:scale-125 duration-300"><svg
                                                        class="size-5" fill="blue" xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 512 512">
                                                        <path
                                            ...
                                            <button type="button" wire:click='delete({{ $perm->id }})'
                                                ...
                                                class="flex text-gray-700 hover:text-blue-800  mx-2 items-center font-semibold rounded-lg border border-transparent disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 hover:scale-125 duration-300"><svg
                                                    fill="red" class="size-5" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 448 512">
                                                    <path
