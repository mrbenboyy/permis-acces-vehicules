<div>
    ...
    <div id="docs-sidebar"
        ...
        <div class="bg-white absolute top-0">
            <img src="{{asset('img/logo.png')}}" alt="logo ONDA">
        </div>
        <nav class="hs-accordion-group p-6 w-full mt-24 flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5">
                <li>
                    <a wire:navigate
                        class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->is('user/*') ? 'bg-gray-100 text-gray-700' : 'text-white' }} text-sm rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-neutral-700 dark:text-white hover:scale-105 duration-300"
                        href="/user/{{auth()->id()}}">
