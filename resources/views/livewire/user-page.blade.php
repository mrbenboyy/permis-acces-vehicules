        ...
        <form wire:submit.prevent="save" class="max-w-sm space-y-3">
            ...
            <div class="relative">
                ...
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 size-4 dark:text-neutral-500"
            ...
            <select id="hs-select-label" wire:model="role"
                class="py-3 px-4 pe-9 block w-full cursor-pointer rounded-lg text-sm disabled:opacity-50  dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                required>
            ...
            <div class="flex justify-end space-x-2">
                @if ($this->id_user)
                    <button type="submit"
                        class="py-3 px-4 w-28 justify-center inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-900 text-white hover:scale-105 duration-300 disabled:opacity-50 disabled:pointer-events-none dark:bg-white dark:text-neutral-800">
                                ...
                                <tr wire:key='{{ $user->id }}' class="hover:bg-gray-100 dark:hover:bg-neutral-700">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        <button type="button" wire:click='edit({{ $user->id }})'
                                            class="inline-flex mx-5 items-start gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 hover:scale-125 duration-300"><svg
                                                class="size-6" fill="blue" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512">
                                                <path
                                        ...
                                        <button type="button" wire:click='delete({{ $user->id }})'
                                            ...
                                            class="inline-flex  mx-5 items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 hover:scale-125 duration-300"><svg
                                                fill="red" class="size-6" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <path
