<div>
    <div class="flex animate__animated animate__fadeIn flex-col mx-3  lg:pl-64">
        ...
        <button wire:confirm="Confirmez-vous la suppression? \n Si vous confirmer ce permis sera definitivement effacé"
            ...
            <svg class="w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M21 4H8l-1-1H1a1 1 0 1 0 0 2h1l1 16a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1l1-16h1a1 1 0 1 0 0-2zm-3 16H6L5 6h14l-1 14z"/>
                <path d="M9 19a1 1 0 1 0 2 0V9a1 1 0 1 0-2 0v10zm4 0a1 1 0 1 0 2 0V9a1 1 0 1 0-2 0v10z"/>
            </svg>
            Supprimer
        </button>
